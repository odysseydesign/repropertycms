                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                        <tr>
                                            <td style="padding: 0px 0px 0px 0px;">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                                    <tr>
                                                        <td valign="top" class="pc-w520-padding-30-30-30-30 pc-w620-padding-35-35-35-35" style="padding: 0px 40px 40px 40px; height: unset; border-radius: 0px; background-color: #383838;" bgcolor="#383838">
                                                                ...
                                                                <tr>
                                                                    <td align="center" valign="top" style="padding: 0px 0px 17px 0px;">
                                                                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="border-collapse: separate; border-spacing: 0; margin-right: auto; margin-left: auto;">
                                                                            <tr>
                                                                                <td valign="top" align="center" style="padding: 20px 0px 0px 0px;">
                                                                                    <div class="pc-font-alt" style="text-decoration: none;">
                                                                                        <div style="font-size: 20px;line-height: 121%;text-align:left;text-align-last:left;color:#46e8ed;letter-spacing:-0.2px;font-weight:400;font-style:normal;font-variant-ligatures:normal;">
                                                                                            <div><span style="font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-size: 20px; line-height: 121%; text-decoration: none; text-transform: none;">Hello {{ $agent->first_name }},</span>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </td>
                                                                                    ...
                                                                                    <div class="pc-font-alt" style="text-decoration: none;">
                                                                                        <div style="font-size: 15px;line-height: 21px;text-align:center;text-align-last:center;color:#46e8ed;font-style:normal;font-weight:400;letter-spacing:-0.2px;font-variant-ligatures:normal;">
                                                                                            <div><span style="font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-size: 15px; line-height: 21px; text-decoration: none; text-transform: none;">We are so excited to have you at Realty Interface! It is our hope that you find our property websites a perfect choice for your luxury estate homes.</span>
                                                                                                ...
                                                                                                <br>
                                                                                                <br><span style="font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-size: 15px; line-height: 21px; text-decoration: none; text-transform: none;">That is the beauty and design of property storytelling.&nbsp;</span>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </td>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                        <tr>
                                            <td style="padding: 0px 0px 0px 0px;">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                                    <tr>
                                                        <td valign="top" class="pc-w520-padding-30-30-30-30 pc-w620-padding-35-35-35-35" style="padding: 0px 40px 0px 40px; height: unset; border-radius: 0px; background-color: #515151;" bgcolor="#515151">
                                                            <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                                <tr>
                                                                    <td align="center" style="padding: 30px 0px 30px 0px;">
                                                                        <table class="pc-width-fill pc-w620-gridCollapsed-1" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                                            <tr class="pc-grid-tr-first pc-grid-tr-last">
                                                                                <td class="pc-grid-td-first pc-w620-itemsSpacings-0-20" align="left" valign="top" style="width: 50%; padding-top: 0px; padding-right: 19px; padding-bottom: 0px; padding-left: 0px;">
                                                                                ...
                                                                                <td class="pc-grid-td-last pc-w620-itemsSpacings-0-20" align="left" valign="top" style="width: 50%; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 19px;">
                                                                                    <table style="border-collapse: separate; border-spacing: 0; width: 100%;" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                                                        <tr>
                                                                                            <td align="left" valign="top" style="padding: 35px 0px 0px 0px;">
                                                                                                <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width: 100%;">
                                                                                                    <tr>
                                                                                                        <td align="left" valign="top">
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    <td valign="top" style="padding: 0px 0px 0px 25px;">
                                                                                                                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="border-collapse: separate; border-spacing: 0;">
                                                                                                                            <tr>
                                                                                                                                <td valign="top" align="center" style="padding: 0px 0px 35px 17px;">
                                                                                                                                    <div class="pc-font-alt" style="text-decoration: none;">
                                                                                                                                        <div style="font-size: 38px;line-height: 45px;text-align:center;text-align-last:center;color:#38dbe2;letter-spacing:-0.2px;font-weight:400;font-style:normal;font-variant-ligatures:normal;">
                                                                                                                                            <div><span style="font-family: 'Georgia', Times New Roman, Times, serif; font-size: 38px; line-height: 45px; text-decoration: none; text-transform: none;">Ready to</span>
                                                                                                                                                <br><span style="font-family: 'Georgia', Times New Roman, Times, serif; font-size: 38px; line-height: 45px; text-decoration: none; text-transform: none;">Start?</span>
                                                                                                                                            </div>
                                                                                                                                        </div>
                                                                                                                                    </div>
                                                                                                                                </td>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                        <tr>
                                            <td style="padding: 0px 0px 0px 0px;">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                                    <tr>
                                                        <td valign="top" class="pc-w520-padding-25-30-0-30 pc-w620-padding-25-35-0-35" style="padding: 50px 40px 60px 40px; height: unset; border-radius: 0px; background-color: #383838;" bgcolor="#383838">
                                                            <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="border-collapse: separate; border-spacing: 0; margin-right: auto; margin-left: auto;">
                                                                <tr>
                                                                    <td valign="top" align="center">
                                                                        <div class="pc-font-alt" style="text-decoration: none;">
                                                                            <div style="font-size: 32px;line-height: 42px;text-align:center;text-align-last:center;color:#38dbe2;font-style:normal;font-weight:400;letter-spacing:-0.2px;font-variant-ligatures:normal;">
                                                                                <div><span style="font-family: 'Georgia', Times New Roman, Times, serif; font-size: 32px; line-height: 42px; text-decoration: none; text-transform: none;">Our Tutorial takes you through</span>
                                                                                    <br><span style="font-family: 'Georgia', Times New Roman, Times, serif; font-size: 32px; line-height: 42px; text-decoration: none; text-transform: none;">every step of the way!</span>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                        <tr>
                                            <td style="padding: 0px 0px 0px 0px;">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                                    <tr>
                                                        <td valign="top" class="pc-w520-padding-30-30-30-30 pc-w620-padding-35-35-35-35" style="padding: 40px 40px 0px 40px; height: unset; border-radius: 0px; background-color: #515151;" bgcolor="#515151">
                                                            <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                                <tr>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                        <tr>
                                            <td style="padding: 0px 0px 0px 0px;">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                                    <tr>
                                                        <td valign="top" class="pc-w520-padding-15-30-0-30 pc-w620-padding-15-35-0-35" style="padding: 0px 40px 0px 40px; height: unset; border-radius: 0px; background-color: #54524f;" bgcolor="#54524f">
                                                            <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="border-collapse: separate; border-spacing: 0; margin-right: auto; margin-left: auto;">
                                                                <tr>
                                                                    <td valign="top" align="left" style="padding: 40px 0px 40px 0px;">
                                                                        <div class="pc-font-alt" style="text-decoration: none;">
                                                                            <div style="font-size: 30px;line-height: 24px;text-align:center;text-align-last:center;color:#c7cbce;font-style:normal;font-weight:400;letter-spacing:-0.1px;font-variant-ligatures:normal;">
                                                                                <div><span style="font-family: 'Times New Roman', Times, serif; font-size: 30px; line-height: 24px; text-decoration: none; text-transform: none;">WE JUST HAVE TO SAY</span>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                        <tr>
                                            <td style="padding: 0px 0px 0px 0px;">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                                    <tr>
                                                        <td valign="top" class="pc-w520-padding-5-0-15-0 pc-w620-padding-5-0-15-0" style="padding: 0px 0px 0px 0px; height: unset; border-radius: 0px; background-color: #524d46;" bgcolor="#524d46">
                                                            <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                                <tr>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                        <tr>
                                            <td style="padding: 0px 0px 0px 0px;">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                                    <tr>
                                                        <td valign="top" class="pc-w520-padding-30-30-30-30 pc-w620-padding-35-35-35-35" style="padding: 40px 40px 40px 40px; height: unset; border-radius: 0px; background-color: #383838;" bgcolor="#383838">
                                                            <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                                <tr>
                                                                                                        ...
                                                                                                        <td align="center" valign="top">
                                                                                                            <table border="0" cellpadding="0" cellspacing="0" role="presentation" align="center" style="border-collapse: separate; border-spacing: 0;">
                                                                                                                <tr>
                                                                                                                    <td valign="top" align="left">
                                                                                                                        <div class="pc-font-alt" style="text-decoration: none;">
                                                                                                                            <div style="font-size: 14px;line-height: 171%;text-align:left;text-align-last:left;color:#38dbe2;letter-spacing:-0.2px;font-weight:500;font-style:normal;font-variant-ligatures:normal;">
                                                                                                                                <div><span style="font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-size: 14px; line-height: 171%; text-decoration: none; text-transform: none;">Unsubscribe</span>
                                                                                                                                </div>
                                                                                                                            </div>
                                                                                                                        </div>
                                                                                                                    </td>

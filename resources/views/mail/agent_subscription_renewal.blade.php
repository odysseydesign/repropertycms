                                                                                ...
                                                                                <td valign="top" align="left">
                                                                                    <div class="pc-font-alt" style="text-decoration: none;">
                                                                                        <div style="font-size: 30px;line-height: 42px;text-align:left;text-align-last:left;color:#38dbe2;letter-spacing:-0.2px;font-weight:700;font-style:normal;font-variant-ligatures:normal;">
                                                                                            <div><span style="font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-size: 32px; line-height: 42px; text-decoration: none; text-transform: none;" class="pc-w620-font-size-30px pc-w620-line-height-133pc">Subscription Renewal</span>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </td>
                                                                                ...
                                                                                <td valign="top" align="left">
                                                                                    <div class="pc-font-alt" style="text-decoration: none;">
                                                                                        <div style="font-size: 15px;line-height: 21px;text-align:left;text-align-last:left;color:#46e8ed;font-style:normal;font-weight:400;letter-spacing:-0.2px;font-variant-ligatures:normal;">
                                                                                            <div><span style="font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-size: 15px; line-height: 21px; text-decoration: none; text-transform: none;">Your subscription has been successfully renewed.</span>
                                                                                            </div>

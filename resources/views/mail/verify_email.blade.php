                                                                                ...
                                                                                <td valign="top" align="left">
                                                                                    <div class="pc-font-alt" style="text-decoration: none;">
                                                                                        <div style="font-size: 30px;line-height: 42px;text-align:left;text-align-last:left;color:#38dbe2;letter-spacing:-0.2px;font-weight:700;font-style:normal;font-variant-ligatures:normal;">
                                                                                            <div><span style="font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-size: 32px; line-height: 42px; text-decoration: none; text-transform: none;" class="pc-w620-font-size-30px pc-w620-line-height-133pc">Verify Email Address</span>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </td>
                                                                                ...
                                                                                <td valign="top" align="left">
                                                                                    <div class="pc-font-alt" style="text-decoration: none;">
                                                                                        <div style="font-size: 15px;line-height: 21px;text-align:left;text-align-last:left;color:#46e8ed;font-style:normal;font-weight:400;letter-spacing:-0.2px;font-variant-ligatures:normal;">
                                                                                            <div><span style="font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-size: 15px; line-height: 21px; text-decoration: none; text-transform: none;">Please click the button below to verify your email address.</span>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </td>
                                                                                                                    ...
                                                                                                                    <td valign="top">
                                                                                                                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" align="left" style="border-collapse: separate; border-spacing: 0;">
                                                                                                                            <tr>
                                                                                                                                <td valign="top" align="left">
                                                                                                                                    <div class="pc-font-alt" style="text-decoration: none;">
                                                                                                                                        <div style="font-size: 15px;line-height: 171%;text-align:center;text-align-last:center;color:#38dbe2;letter-spacing:-0.2px;font-weight:500;font-style:normal;font-variant-ligatures:normal;">
                                                                                                                                            <div><span style="font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-size: 15px; line-height: 171%; text-decoration: underline; text-transform: none;">Contact Us</span>
                                                                                                                                            </div>
                                                                                                                                        </div>
                                                                                                                                    </div>
                                                                                                                                </td>
